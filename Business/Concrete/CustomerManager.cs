...
namespace Business.Concrete
{
    public class CustomerManager : ICustomerService
    {
        ...
        public IDataResult<List<Customer>> GetAll()
        {
            ...
            return new SuccesDataResult<List<Customer>>(value, Messages.CustomerGetAll);
        }

        public IDataResult<Customer> GetById(int id)
        {
            var value = _customerDal.Get(p => p.CustomerId == id);
            return new SuccesDataResult<Customer>(value, Messages.CustomerGetById);
        }

        public IDataResult<List<CustomerDetailDto>> GetCustomerDetails()
        {
            var value = _customerDal.GetCustomerDetails();
            return new SuccesDataResult<List<CustomerDetailDto>>(value, Messages.CustomerDetail);
        }
